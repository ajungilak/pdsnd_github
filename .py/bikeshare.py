...
def station_stats(df):
    ...
    print("The most commonly used end station from the provided fitered data is: " + common_end_station)
...
def trip_duration_stats(df):
    ...
    print("The total travel time from the provided fitered data is: " + str(total_travel_time))

    # TO DO: display mean travel time
    mean_travel_time = df['Trip Duration'].mean()
    print("The mean travel time from the provided fitered data is: " + str(mean_travel_time))
...
def user_stats(df, city):
    ...
    print("The count of user types from the provided fitered data is: \n" + str(user_types))

    if city == 'chicago.csv' or city == 'new_york_city.csv':
        # TO DO: Display counts of gender
        gender = df['Gender'].value_counts()
        print("The count of user gender from the provided fitered data is: \n" + str(gender))

        # TO DO: Display earliest, most recent, and most common year of birth
        earliest_birth = df['Birth Year'].min()
        most_recent_birth = df['Birth Year'].max()
        most_common_birth = df['Birth Year'].mode()[0]
        print('Earliest birth from the provided fitered data is: {}\n'.format(earliest_birth))
        print('Most recent birth from the provided fitered data is: {}\n'.format(most_recent_birth))
        print('Most common birth from the provided fitered data is: {}\n'.format(most_common_birth) )
